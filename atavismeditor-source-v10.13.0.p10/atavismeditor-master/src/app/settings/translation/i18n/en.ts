export const locale = {
  ...
  "GAME_SETTING": {
    ...
    "SENDTOCLIENT_HELP": "Select if you want to send Game Setting to Client.",
    "DESCRIPTION": "Description",
    "DESCRIPTION_HELP": "Game Setting Description",
    "DESCRIPTION2": "",
    "CATEGORY": "Category",
  ...
  "RANKINGS": {
    ...
    "PARAM1": "Currency",
    "PARAM1_HELP": "Choose Currency",
    "PARAM2": "Faction",
    "PARAM2_HELP": "Choose Faction",
    "SUB_TYPE": "Sub Type",
    "SUB_TYPE_HELP": "Choose Sub Type",
    "NAME": "Name",
    ...
    "POS": "Position Number",
    "POS_HELP": "Position number nn Ranking",
    "COLOR": "Color",
    "COLOR_HELP": "Select color for this position on Ranking",
  ...
  "LOOT_TABLE": {
    ...
    "CHANCE2": "Expected Chance",
    "CHANCE2_HELP": "The Expected percentage chance that this item will be chosen to drop by the server."
  },
  "MOBS_SPAWN_DATA": {
    ...
    "CORPSEDESPAWNTIME": "Corpse Despawn Time (ms)",
  ...
  "FACTION": {
    ...
    "ID": "ID",
    "COLOR": "Color",
    "COLOR_HELP": "Place color hex code like (#FFFFFF)",
    "ICON2": "Icon Base64",
    "ICON": "Icon",
    "ICON_HELP": "Choose the icon for Faction.",
    "NAME": "Name",
    ...
    "FACTIONGROUP": "Group",
    "FACTIONGROUP_HELP": "Choose a group to assign this Faction to. This is for the player UI.",
    ...
    "CANENTERGUILD": "Can Create or enter guild",
    "CANENTERGUILD_HELP": "Can Create or enter guild",
    "STANCE": {
      "HATED": "Hated",
      "DISLIKED": "Disliked",
      "NEUTRAL": "Neutral",
  ...
  "SKILLS": {
    "TITLE": "Skills",
    "TITLE_TOOLTIP": "In this section you will define Skills that your players can obtain and level up in your game. Skills are like containers that hold Abilities that your players can use. For WoW-style **class spells by character level**, use **Character → Class Abilities by Level**. For **talent trees**, enable Talent on a skill and set tree_id / tier / column. Click this link for more information. [Skills Wiki](https://unity.wiki.atavismonline.com/project/skills-plugin/) ",
    ...
    "TALENT": "Talent",
    "TALENT_HELP": "WoW talents: check for talent-tree skills (spent with talent points from level 10). Class spells learned by character level are configured in Character → Class Abilities by Level, not here.",
    "TREE_ID": "Talent Tree",
    "TREE_ID_HELP": "WoW tree index: 0 / 1 / 2 (e.g. Arms / Fury / Protection). Only used when Talent is enabled.",
    "TIER": "Tier (Row)",
    "TIER_HELP": "Talent row from top (tier 1 = first row). Tier gate: (tier-1) × 5 points in this tree (WotLK).",
    "COLUMN": "Column",
    "COLUMN_HELP": "Horizontal position in the talent row.",
    "TREE_POINTS_REQUIRED": "Tree Points Required",
    "TREE_POINTS_REQUIRED_HELP": "Manual points required in this tree before this talent. Leave 0 for auto WotLK gate (tier-1)×5.",
    "EXCLUSIVE_GROUP": "Exclusive Group",
    "EXCLUSIVE_GROUP_HELP": "Optional: only one talent per group per row (custom). WotLK default: leave 0.",
    "CLASS_SPELLS_TITLE": "Class spells by level → use Character → Class Abilities by Level",
    "TYPE": "Skill Type",
  ...
  "ABILITY": {
    ...
    "ENTERCOMBATSTATE": "Enter Combat State",
    "ENTERCOMBATSTATE_HELP": "Select if you wont to enter combat when using ability",
    "PVP_ENTER": "Enter / Exit PvP",
    "PVP_ENTER_HELP": "Enter / Exit PvP in Outlaw Region",
  },
  "CLASS_ABILITY_BY_LEVEL": {
    "TITLE": "Class Abilities by Level",
    "TITLE_TOOLTIP": "WoW-style class spell book: define which abilities players automatically learn at each character level (separate from talent points). Configure per class (aspect) and player level. Requires AGIS `class_ability_by_level` table and `CLASS_ABILITIES_BY_LEVEL_ENABLED` game setting.",
    "SEARCH_PLACEHOLDER": "Search class abilities by level",
    "ADD_TITLE": "Add Class Ability",
    "EDIT_TITLE": "Edit Class Ability",
    "FORM_INTRO": "Class spell learned when the player reaches the specified level (WoW spell book model).",
    "ASPECT": "Class",
    "ASPECT_HELP": "Character class (aspect ID) that learns this ability.",
    "PLAYER_LEVEL": "Player Level",
    "PLAYER_LEVEL_HELP": "Character level when this ability is auto-learned (e.g. Charge at level 4).",
    "ABILITY_ID": "Ability",
    "ABILITY_ID_HELP": "Ability from the Abilities editor that is granted at this level.",
    "AUTO_LEARN": "Auto Learn",
    "AUTO_LEARN_HELP": "If enabled, the server learns this ability on level-up and login sync.",
    "UNLEARN_ON_DELEVEL": "Unlearn on Delevel",
    "UNLEARN_ON_DELEVEL_HELP": "If enabled and LOST_LEVEL is on, removes the ability when the player drops below this level.",
    "SORT_ORDER": "Sort Order",
    "SORT_ORDER_HELP": "Order when multiple abilities unlock on the same level (action bar hint)."
  },
  "PLAYER_CHARACTER": {
    "TITLE": "Player Templates",
    "TITLE_TOOLTIP": "In this section you will define the starting templates that will be used when your player creates a character. This includes race, class, gender, starting location, starting stats and progression for those stats, starting skills, starting items, and so on. **Level-up class spells** (WoW spell book) are configured in **Class Abilities by Level** in this same Character section. Click this link for more information.[Player Character Wiki](https://unity.wiki.atavismonline.com/project/player-character-setup-plugin/) ",
    ...
    "SKILL": "Skill",
    "SKILL_HELP": "Starting skills known at character creation (level 0/1 abilities from skill_ability_gain). For abilities learned later by **player level** (WoW-style), use **Class Abilities by Level** in the Character section.",
    "ITEM_ID": "Item",
  ...
  "EFFECTS": {
    ...
    "NEW_FACTION_HELP": "Choose a new faction for which the player faction will be replaced.",
    "FACTION": "Faction",
    "FACTION_HELP": "Choose a faction for which faction will change reputation.",
    "FACTION_REPUTATION": "Reputation",
    "FACTION_REPUTATION_HELP": "Reputation for selected faction.",
    ...
    "SUBTYPES": {
      ...
      "FactionEffect": "Faction Effect",
      "ChangeFactionEffect": "Change Faction Effect",
    }
  },
  "THRESHOLDS": {
  ...
  "PVP_RANKS":{
    "TITLE2": 'PvP Ranks',
    "TITLE2_TOOLTIP": "In this section you will define pvp ranks. Click this link for more information. [PvP Ranks Wiki](https://unity.wiki.atavismonline.com/project/pvp-ranks/)",
    "SEARCH_PLACEHOLDER": "Search for an PvP Rank",
    "ADD_TITLE": "New PvP Rank",
    "EDIT_TITLE": "Update PvP Rank",
    "ID": "Id",
    "NAME": "Name",
    "NAME_HELP": "Name of the Profile",
    "TITLE": 'Title',
    "TITLE_HELP": 'Title of the rank',
    "ICON2": "Icon Base64",
    "ICON": "Cursor Icon",
    "ICON_HELP": "Choose the icon that you want to represent this Rank.",
    "CURRENCY_ID": "Currency",
    "CURRENCY_ID_HELP": "Choose Currency that will be reduced or increased",
    "CURRENCY_INCREASE": "Increase",
    "CURRENCY_INCREASE_HELP": "Currency amount that will be added by pvp kill",
    "CURRENCY_REDUCE": "Reduce",
    "CURRENCY_REDUCE_HELP": "Currency amount that will be reduced by pvp kill",
    "VALUE": "Points for Rank",
    "VALUE_HELP": "Number of Points required for Rank",
    "LEVELDIFF": "Rank level diff",
    "LEVELDIFF_HELP": "Difference in the number of rank levels between the attacker and the victim",
    "CURRENCY_INCREASE_DIFF": "Increase",
    "CURRENCY_INCREASE_DIFF_HELP": "Currency amount that will be added by pvp kill",
    "CURRENCY_REDUCE_DIFF": "Reduce",
    "CURRENCY_REDUCE_DIFF_HELP": "Currency amount that will be reduced by pvp kill",
    "EFFECT_ID": "Effect",
    "EFFECT_ID_HELP": "Select the effect that will be applied if you reach the rank",
    "DIFF_ABOVE": "Rank Diff Above",
    "DIFF_BELOW": "Rank Diff Below",
    "DIFFA": "Rank Diff Above",
    "DIFFB": "Rank Diff Below",
    "ADD_DIFF_ABOVE": "Add Rank Diff Above",
    "ADD_DIFF_BELOW": "Add Rank Diff Below",
  }
};
