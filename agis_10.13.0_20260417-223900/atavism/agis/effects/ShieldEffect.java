...
public class ShieldEffect extends AgisEffect {
    ...
    public void apply(EffectState state) {
		...
		params.put("maxShieldAmount", maxShieldAmount);
		params.put("currentShieldAmount", currentShieldAmount);
		params.put("maxHitCount", maxHitCount);
		params.put("currentHitCount", currentHitCount);
    ...
    public void remove(EffectState state, CombatInfo target) {
		if (target == null)
			return;
		Map<String, Serializable> params = state.getParams();
		int currentShieldAmount =  (int)params.getOrDefault("currentShieldAmount",0);
		int currentHitCount = (int)params.getOrDefault("currentHitCount",0);
		int maxHitCount =  (int)params.getOrDefault("maxHitCount",this.maxHitCount);
		int maxShieldAmount =  (int)params.getOrDefault("maxShieldAmount", this.maxShieldAmount);
		if(Log.loggingDebug)
  ...
  /*  public void setDisplayName(String eName) {
    ...
    */
	...
	void sendShieldUpdate(EffectState state) {
		Map<String, Serializable> params = state.getParams();
		int currentShieldAmount =  (int)params.get("currentShieldAmount");;
		int currentHitCount = (int)params.get("currentHitCount");
		int maxHitCount =  (int)params.get("maxHitCount");
		int maxShieldAmount =  (int)params.get("maxShieldAmount");
