...
public class InventoryInfo extends Entity {
    ...
    public String toString() {
        return "[InventoryInfo: " + getName() + ":" + getOid() + "]";
    }
	...
	public Object clone() throws CloneNotSupportedException {
		lock.lock();
		try {
			InventoryInfo it =  (InventoryInfo)super.clone();
			it.setCurrencies((HashMap<Integer, HashMap<Integer, Long>>) currencies.clone());
			it.setBonuses((HashMap<String, BonusSettings>) getBonuses().clone());
			it.setStorageBags((HashMap<String, OID>) getStorageBags().clone());
			it.setBagsMap((HashMap<Integer, OID[]>) getBagsMap().clone());
			it.setEquippedItemsBagMap((HashMap<Integer, OID>) getEquippedItemsBagMap().clone());
			return it;
		} finally {
			lock.unlock();
		}
