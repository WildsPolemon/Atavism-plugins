...
public class VoxelPlugin extends atavism.server.engine.EnginePlugin {
	...
	void loadData() {
		...
		String useVoxelsToCheckMobVisibility = cnDB.loadGameSetting("USE_VOXELS_TO_CHECK_MOB_VISIBILITY");
		...
		String cwr = cnDB.loadGameSetting("CLAIM_DRAW_RADIUS");
		if (cwr != null) {
			CLAIM_DRAW_RADIUS =  Integer.parseInt(cwr);
			log.debug("Game Settings Loaded CLAIM_DRAW_RADIUS="+CLAIM_DRAW_RADIUS);
		}
