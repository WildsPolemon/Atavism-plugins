...
public class Cooldown implements Serializable, ClientSerializable  {
	...
	public static void activateCooldowns(Collection<Cooldown> cooldowns, CooldownObject obj, double cGlobalMod, double cWeaponMod, double cMod, int attack_speed, boolean cNew) {
		activateCooldowns(cooldowns, obj, cGlobalMod, cWeaponMod, cMod, attack_speed, cNew, true);
	}

    public static void activateCooldowns(Collection<Cooldown> cooldowns, CooldownObject obj, double cGlobalMod, double cWeaponMod, double cMod , int attack_speed, boolean cNew, boolean start) {
