...
public class PlayerCorpseBehavior extends Behavior {
    ...
    public void activate() {
		if (Log.loggingDebug)Log.debug("PlayerCorpseBehavior activate ");
    	activated = true;
		...
		if (Log.loggingDebug)Log.debug("PlayerCorpseBehavior safeDuration="+safeDuration+" corpseDuration="+corpseDuration);
    	...
    	Log.debug("PlayerCorpseBehavior activate end");
