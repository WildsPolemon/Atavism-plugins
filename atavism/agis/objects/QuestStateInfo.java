...
public class QuestStateInfo extends Entity {
    ...
    public String toString() {
        return "[QuestStateInfo: " + getName() + ":" + getOid() + "]";
    }
	...
	public Object clone() throws CloneNotSupportedException {
		lock.lock();
		try {
			QuestStateInfo it =  (QuestStateInfo)super.clone();
			it.setCompletedQuests((HashMap<Integer, ArrayList<Integer>>) getCompletedQuests().clone());
			it.setActiveQuests((HashMap<Integer, HashMap<Integer, QuestState>>) getActiveQuests().clone());
			return it;
		} finally {
			lock.unlock();
		}
