	...
	class RankingDataHook implements Hook {
		public boolean processMessage(Message msg, int flags) {
			...
			for (RankingData r : rd) {
				...
				} else if (r.getType().equals(AchievementsClient.KILL) || r.getType().equals(AchievementsClient.PVP_KILL)|| r.getType().equals(AchievementsClient.HARVEST) || r.getType().equals(AchievementsClient.FINAL_BLOW) || r.getType().equals(AchievementsClient.USE_ABILITY)
