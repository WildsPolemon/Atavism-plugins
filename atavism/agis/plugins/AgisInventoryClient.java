 ...
 */
	 ...
	 * @param value
	 */
	public static void setCurrency(OID oid, int currencyType, long value) {
		alterCurrencyMessage msg = new alterCurrencyMessage(oid, currencyType, value);
		msg.setSetValue(true);
		Engine.getAgent().sendBroadcast(msg);
	 ...
	 * @param value
	 */
	public static void setCurrencyAllPlayers( int currencyType, long value) {
		GenericMessage msg = new GenericMessage(MSG_TYPE_ALTER_CURRENCY_ALL_PLAYERS);
		msg.setProperty("currencyType", currencyType);
	...
	public static class alterCurrencyMessage extends PropertyMessage {
		...
		public void setSetValue(boolean value) { setValue= value; }
...
public static class UpdateStorageSizeMessage extends SubjectMessage {
	...
	public static void sendCurrencyAltered(OID oid,int currency, long amount) {
		PropertyMessage sm = new PropertyMessage(MSG_TYPE_CURRENCY_ALTERED, oid );
		sm.setProperty("currency", currency);
		sm.setProperty("amount", amount);
		Engine.getAgent().sendBroadcast(sm);
		Log.debug("sendCurrencyAltered hit 1");
	}
	...
	public static final MessageType MSG_TYPE_ALTER_CURRENCY_ALL_PLAYERS = MessageType.intern("inventory.ALTER_CURRENCY_ALL_PLAYERS");
	...
	public static final MessageType MSG_TYPE_CURRENCY_ALTERED = MessageType.intern("inventory.CURRENCY_ALTERED");
