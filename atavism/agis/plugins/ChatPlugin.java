...
public class ChatPlugin extends EnginePlugin {
  ...
  //  HashMap<OID, ScheduledFuture> tasks = new HashMap<OID, ScheduledFuture>();
	...
	public void onActivate() {
		...
		filter.addType(ChatClient.MSG_TYPE_COM_PVP);
	...
	public void RegisterHooks() {
		...
		getHookManager().addHook(ChatClient.MSG_TYPE_COM_PVP, new PvpMessageHook());
	...
	public class PvpMessageHook implements Hook {
		public boolean processMessage(Message msg, int flags) {
			PropertyMessage getMsg = (PropertyMessage) msg;
...
//			String plyName = aDB.getCharacterNameByOid(playerOid);
			...
			comMessage.setChatterName("System");
			if (chatChannel == -10) {
				// Global chat
