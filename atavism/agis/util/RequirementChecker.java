...
public class RequirementChecker {
	...
	/**
	 * Checks if the player meets all the requirements specified in the requirement's map.
	 * @param oid
	 * @param requirements
	 */
	public static RequirementCheckResult DoesPlayerMeetRequirements(OID oid, HashMap<Integer, HashMap<String, Integer>> requirements) {
		return DoesPlayerMeetRequirements(oid, requirements, false, null);
	}
		/**
		 * Checks if the player/pet meets all the requirements specified in the requirement's map.
		 * @param oid
		 * @param requirements
		 * @param isPet
		 * @param petInfo
		 */
		public static RequirementCheckResult DoesPlayerMeetRequirements(OID oid, HashMap<Integer, HashMap<String, Integer>> requirements,boolean isPet, PetInfo petInfo ) {
