  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Цінники та етикетки</h1>
          <p className="text-sm text-muted">Друк цінників зі штрихкодом (як AinurPOS)</p>
        </div>
        <button onClick={print} disabled={!selected.length} className="rounded-xl bg-accent px-4 py-2 text-sm font-medium disabled:opacity-40">Друк ({selected.length})</button>
      </div>
